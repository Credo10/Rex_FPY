...
namespace FPY
{
    public partial class frm24HourStacked : clsForm
    {
        ...
        private void frm24HourStacked_Load(object sender, EventArgs e)
        {
            this.LNID = 1;
        ...
        private void frm24HourStacked_Shown(object sender, EventArgs e)
        {
                ...
                switch (y)
                {
                    case (1):
                        for (int z = 0; z <= 6; z++)
                        {
                            ...
                            {
                                //gvHours.Rows[0].Cells[z].Value = strHour;
                                gvHours1.Rows[0].Cells[z].Value = TwelveHour(z);
                                setHour = z;  
                            }
                            else
                            {
                    ...
                    case (2):
                        for (int z = 0; z <= 6; z++)
                        {
                            ...
                            {
                                //gvHours.Rows[0].Cells[z].Value = strHour;
                                gvHours2.Rows[0].Cells[z].Value = TwelveHour(z + 6);
                                setHour = z+6;  
                            }
                            else
                            {
                    ...
                    case (3):
                        for (int z = 0; z <= 6; z++)
                        {
                            ...
                            gvHours3.BorderStyle = BorderStyle.None;
                            gvHours3.Columns.Add(col2);
                            gvHours3.Height = gvHours1.Rows[0].Height;
                            ...
                            {
                                //gvHours.Rows[0].Cells[z].Value = strHour;
                                gvHours3.Rows[0].Cells[z].Value = TwelveHour(z + 12);
                                setHour = z + 12; 
                            }
                            else
                            {
                    ...
                    case (4):
                        for (int z = 0; z <= 6; z++)
                        {
                            ...
                            {
                                //gvHours.Rows[0].Cells[z].Value = strHour;
                                gvHours4.Rows[0].Cells[z].Value = TwelveHour(z + 18);
                                setHour = z + 18; 
                            }
                            else
                            {
                ...
                case (1):
                    ...
                    for (int z = 0; z < 359; z++)
                    {
                        foreach (var x in loopLeakTest)
                        {
                            ...
                            //    if (ct.Item4 == z)
                            //    {
                            //        SetSpan(gvTrueCycle1, ct.Item4, 0, ct.Item3, 0, "Middle");
                            //        gvTrueCycle1.Rows[0].Cells[ct.Item4].Value = ct.Item3.ToString() + " min";
                            //        gvTrueCycle1.Rows[0].Cells[ct.Item4].Style.Font = new Font("Arial", 10F, FontStyle.Bold, GraphicsUnit.Pixel);
                            //    }
                            //}
                    ...
                    try
                    {
                        for (int z = 0; z < 359; z++)
                        {
                            foreach (var x in loopLeakTest)
                            {
                                ...
                                //    if (ct.Item4 == z + 360 && z + x.Item3 < 360)
                                //    {
        ...
        private void btnPKU2_Click(object sender, EventArgs e)
        {
            ...
            frm24HourStacked_Shown(btnPKU2, EventArgs.Empty);
        }
        ...
        {
            trueCycleTimes.Clear();
            frm24HourStacked_Shown(timer1, EventArgs.Empty);
        }
    }
}
