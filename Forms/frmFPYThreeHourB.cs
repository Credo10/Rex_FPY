...
namespace FPY
{
    public partial class frmFPYThreeHourB : clsForm
    {
        ...
        public frmFPYThreeHourB()
        {
            InitializeComponent();
            
        }

        private void frmFPYThreeHourB_Load(object sender, EventArgs e)
        {
        ...
        private void frmFPYThreeHourB_Shown(object sender, EventArgs e)
        {
            if(this.LNID == 1)
            {
                this.lblLine.Text = "PKU 1";
                strLineSpecificStoredProc = "p_tblLeakTestFPYThreeHourPKU1 ";
                strLineSpecificPctStoredProc = "p_tblLeakTestFPYPctsPKU1 ";
            }

            if (this.LNID == 2)
            {
                this.lblLine.Text = "PKU 2";
                strLineSpecificStoredProc = "p_tblLeakTestFPYThreeHourPKU2 ";
                strLineSpecificPctStoredProc = "p_tblLeakTestFPYPctsPKU2 ";
        ...
        private void SetGrids(string strHour)
        {
            ...
            try
            {
                ...
                string strSQL = strLineSpecificStoredProc + intHourSP.ToString();
        ...
        private void SetPcts()
        {
            ...
            try
            {
                ...
                if (clsDAL.dsHasData(ds))
                {
                    ...
                    intFPYShiftTarget = Convert.ToInt32(dt4.Rows[0]["FPY_ShiftTarget"].ToString());
                    intFPY24Target = Convert.ToInt32(dt4.Rows[0]["FPY_TwentyFourTarget"].ToString());
                    ...
                    lblCycleTime.Text = "Cycle Time: " + dt3.Rows[0]["LTCY_Time"].ToString() + " min";
                    ...
                    lblPartNo.Text = "Part Number: " + dt3.Rows[0]["LTCY_Part"].ToString();
        ...
        {
            this.LNID = 1;
            frmFPYThreeHourB_Shown(btnPKU2, EventArgs.Empty);
        }

        private void btnPKU2_Click(object sender, EventArgs e)
        {
            this.LNID = 2;
            frmFPYThreeHourB_Shown(btnPKU1, EventArgs.Empty);
        }
    }
