...
public partial class tblAppFilter
{

    public int AFLTID { get; set; }

    public int NAVID { get; set; }

    public string AFLT_Token { get; set; }

    public System.DateTime AFLT_TimeStamp { get; set; }

    public string AFLT_GV { get; set; }
